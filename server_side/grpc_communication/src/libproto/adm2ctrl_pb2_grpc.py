...
import libproto.adm2ctrl_pb2 as adm2ctrl__pb2
...
class DtoCStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExecZhncha = channel.unary_unary(
                ...
                request_serializer=adm2ctrl__pb2.ZhnchaRequest.SerializeToString,
                response_deserializer=adm2ctrl__pb2.ZhnchaReply.FromString,
                )
...
def add_DtoCServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ExecZhncha': grpc.unary_unary_rpc_method_handler(
                    servicer.ExecZhncha,
                    request_deserializer=adm2ctrl__pb2.ZhnchaRequest.FromString,
                    response_serializer=adm2ctrl__pb2.ZhnchaReply.SerializeToString,
            ),
...
class DtoC(object):
    ...
    def ExecZhncha(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/adm2ctrl.DtoC/ExecZhncha',
            adm2ctrl__pb2.ZhnchaRequest.SerializeToString,
            adm2ctrl__pb2.ZhnchaReply.FromString,
