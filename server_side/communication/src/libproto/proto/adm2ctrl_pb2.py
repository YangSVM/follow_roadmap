...
_ZHNCHAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='start_zhncha', full_name='adm2ctrl.ZhnchaRequest.start_zhncha', index=0,
...
_ZHNCHAREPLY = _descriptor.Descriptor(
  name='ZhnchaReply',
  full_name='adm2ctrl.ZhnchaReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='zhncha_flag', full_name='adm2ctrl.ZhnchaReply.zhncha_flag', index=0,
...
DESCRIPTOR.message_types_by_name['ZhnchaRequest'] = _ZHNCHAREQUEST
DESCRIPTOR.message_types_by_name['ZhnchaReply'] = _ZHNCHAREPLY
...
ZhnchaRequest = _reflection.GeneratedProtocolMessageType('ZhnchaRequest', (_message.Message,), {
  'DESCRIPTOR' : _ZHNCHAREQUEST,
  '__module__' : 'proto.adm2ctrl_pb2'
  # @@protoc_insertion_point(class_scope:adm2ctrl.ZhnchaRequest)
  })
_sym_db.RegisterMessage(ZhnchaRequest)

ZhnchaReply = _reflection.GeneratedProtocolMessageType('ZhnchaReply', (_message.Message,), {
  'DESCRIPTOR' : _ZHNCHAREPLY,
  '__module__' : 'proto.adm2ctrl_pb2'
  # @@protoc_insertion_point(class_scope:adm2ctrl.ZhnchaReply)
  })
_sym_db.RegisterMessage(ZhnchaReply)
...
_DTOC = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ExecZhncha',
    full_name='adm2ctrl.DtoC.ExecZhncha',
    index=0,
    containing_service=None,
    input_type=_ZHNCHAREQUEST,
    output_type=_ZHNCHAREPLY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
